...
//
//@Slf4j
//public final class OpenMetadataTransport  implements Closeable {
//
...
//  }
//
//  private String extractTableNamesFromSymlinks(OpenLineage.Dataset dataset) {ƒ
...
//      if (inputTablesendToOpenMetadataName == null) {
//        continue;
//      }
...
//        HttpPut request = createLineageRequest(pipelineId, fromEntity, toEntity, fromTable, toTable);
//        sendRequest(request);
//      }
//    } catch (Exception e) {
//      e.printStackTrace();
...
//    edgeMap.put("toEntity", createEntityMap(toEntity.get("entityType").toString(), toEntity.get("id").toString()));
//    edgeMap.put("fromEntity", createEntityMap(fromEntity.get("entityType").toString(), fromEntity.get("id").toString()));
...
//    lineageDetails.put("columnsLineage", getColumnLevelLineage(fromEntity, toEntity, fromTable, toTable));
...
//  }
//
//  private Map<String, Object> fromJsonString(String jsonString) throws IOException {
